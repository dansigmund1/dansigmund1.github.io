...
export class Home {
  ...
  skills: SkillsItem[] =[
    ...
    { skill_name: 'SQL', skill_des: 'SQL drives my data layer work, from writing complex queries and' +
      ...
      'reporting pipelines and data validation workflows, prioritizing clarity and performance in every query', skill_logo: '' },
    { skill_name: 'TypeScript', skill_des: 'TypeScript powers my frontend and full-stack development, from' +
       ...
       'to write more reliable, maintainable code.', skill_logo: '' },
    { skill_name: 'Linux', skill_des: 'Linux underpins my development environment, from navigating the command line' +
       ...
       'development workflows and development pipelines, relying on its flexibility and control to get things done efficiently.', skill_logo: '' },
    { skill_name: 'Postman', skill_des: 'Postman is my go-to tool for API development and testing, from crafting and debugging' +
       ...
       'backend integration work, using it to ensure APIs behave as expected before and after deployment', skill_logo: '' },
    { skill_name: 'Excel', skill_des: 'Excel extends my data toolkit beyond code, from organizing and cleaning datasets to' +
       ...
       'transform, and validate data as part of broader ingestion and reporting workflows.', skill_logo: '' }
  ];
}